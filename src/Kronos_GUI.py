...
class Kronos_GUI(tk.Frame):
	...
	def update_method_options(self, *args):
		...
		directory = fu.data_file_dir(ion,ioniz,neutral,method)
	...
	def get_file_path (self, *args):
		...
		FileDir = fu.data_file_dir(ion, ioniz, neutral,method)
	...
	def Run_Cascade(self, *args):
		...
		File_Dir = fu.data_file_dir(ion, ioniz, neutral,method)
